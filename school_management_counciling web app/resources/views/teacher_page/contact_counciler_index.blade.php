                    ...
                    <div class="form-group  required">
                        ...
                        <div class="input-group">
                            <select name="studnet_id" id="studnet_id"
                                ...
                                @foreach ($councilors as $counciler)
                                <option value="{{$counciler->id}}"
                                    {{old('counciler_id') == $counciler->id ? 'selected' : ''}}>
                                    {{$counciler->name}}
                                </option>
                                @endforeach

                            </select>
                            @if ($errors->has('counciler_id'))
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $errors->first('counciler_id') }}</strong>
                            </span>
                            @endif
                            <span class="invalid-feedback" role="alert"></span>
                        </div>
